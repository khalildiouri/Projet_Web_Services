...
<title>Liste des Commentaires ADMIN</title>
<!-- Link shortcut icon-->
...
<body class="dashborad">
	...
	<div id="left_menu">
		<ul id="main_menu" class="main_menu">
			...
			<li class="limenu"><a href="/Client/toAddBook.do"><span
			...
			<li class="limenu"><a href="/Client/toCommentsAdminBook.do"><span
					class="ico gray shadow home"></span><b>Consulter Commentaires
						sur Livres</b></a></li>
	</div>
	...
	<div id="content">
		<div class="inner">
			...
			<div class="onecolumn">
				<div class="header">
					<span><span class="ico color window">Liste des commentaires par Livre :</span></span>
				</div>
				<div class="clear"></div>
				<div class="content">
						...
						<div class="load_page">
							...
							<div>
								<div>
									...
									<f:form method="post" action="ShowCommentsBookAdmin.do">

										<table style="font-size: 10pt">

											<tr>
												<td>Selectionnez un livre :</td>
												<td><select name="c">
														<s:forEach items="${books }" var="o">
															<option value="${ o.isbn}">livre : ${o.title }
																écrit par : ${o.author}</option>
														</s:forEach>
												</select></td>
											</tr>
									...
									<table class="display static ">
										<thead>
											<tr>
												...
												<th width="200">Contenue(Commentaire)</th>
											</tr>
										</thead>
										<tbody>
											<s:forEach items="${commts}" var="m">
												<tr>
													<td>${m.title}</td>
													<td>${m.author}</td>
													<td>${m.description}</td>
