...
<title>Ajouter Commentaire ADMIN</title>
<!-- Link shortcut icon-->
...
<body class="dashborad">
	...
	<div id="left_menu">
		<ul id="main_menu" class="main_menu">
			...
			<li class="limenu "><a href="/Client/toBorrowBookADMIN.do"><span
					class="ico gray shadow window"></span><b>Emprunté livres</b></a>
				</li>
			<li class="limenu"><a href="#"><span
				...
				<li class="limenu"><a href="/Client/toUpdateBook.do"><span
					class="ico gray shadow home"></span><b>Modifier Livre</b></a></li><li class="limenu"><a
	...
	<div id="content">
		<div class="inner">
			...
			<div class="onecolumn">
				<div class="header">
					<span><span class="ico color window"></span>Commentaires :</span>
				</div>
				<div class="clear"></div>
				<div class="content">
									...
									<f:form method="post"
										...
										<table style="font-size: 10pt">
											...
											<tr>
												...
												<td>contenue :</td>
												<td><textarea name="content" value="${content }"></textarea></td>
											</tr>
											<!--  -->
