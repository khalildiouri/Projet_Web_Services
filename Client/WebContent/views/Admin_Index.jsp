...
<body class="dashborad">
		...
		<ul id="main_menu" class="main_menu">
			...
			<li class="limenu"><a href="#"><span
				...
				href="/Client/toAddBook.do"><span
					class="ico gray shadow spreadsheet"></span><b>Ajouter Livre</b></a></li>
			<li class="limenu"><a
				href="/Client/toUpdateBook.do"><span
					class="ico gray shadow fingerprint"></span><b>Modifier Livre</b></a></li>
					<li class="limenu"><a href="/Client/toCommentsAdminBook.do"><span
					class="ico gray shadow spreadsheet"></span><b>Consulter Commentaires sur Livres</b></a></li>	
	...
	<div id="content">
		<div class="inner">
			...
			<div class="onecolumn">
				<div class="header">
					<span><span class="ico color window"></span>Liste des livres dans la bibliothèque </span>
				</div>
				<div class="clear"></div>
				<div class="content">
