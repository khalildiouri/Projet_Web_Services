...
<body class="dashborad">
	...
	<div id="left_menu">
		<ul id="main_menu" class="main_menu">
			<li class="limenu"><a href="/Client/welcomeAdmin.do"><span
					class="ico gray shadow home"></span><b>Dashboard</b></a></li>
			<li class="limenu "><a href="/Client/toBorrowBook.do"><span
					class="ico gray shadow window"></span><b>Emprunté livres</b></a></li>
			<li class="limenu"><a href="#"><span
					class="ico gray shadow window"></span><b>Commentaires </b></a>
				<ul>
					<li><a href="/Client/AdminAddComment.do"> Ajouter </a></li>
					<li><a href="/Client/toListCompteADMIN.do"> Lister </a></li>
				</ul></li>
				<li class="limenu"><a
				href="/Client/toAddBook.do"><span
					class="ico gray shadow home"></span><b>Ajouter Livre</b></a></li>
					<li class="limenu"><a
				href="/Client/toUpdateBook.do"><span
					class="ico gray shadow home"></span><b>Modifier Livre</b></a></li>
				<li class="limenu"><a
				href="/Client/toCommentsAdminBook.do"><span
					class="ico gray shadow home"></span><b>Consulter Commentaires sur Livres</b></a></li>	</ul>
	...
	<div id="content">
		<div class="inner">
			...
			<div class="onecolumn">
				<div class="header">
					<span><span class="ico color window"></span>Ajouter Livre</span>
				</div>
				<div class="clear"></div>
				<div class="content">
						...
						<div class="load_page">
							...
							<div>
								<div>
									...
									<f:form method="post" commandName="book"
										action="AddBook.do">
										...
										<table style="font-size: 10pt">
											...
											<tr>
												<td>ISBN :*</td>
												<td><f:input path="isbn"  />
												<span class="f_help"><f:errors  path="isbn"></f:errors></span></td>
											...
											<tr>
												...
												<span class="f_help"><f:errors path="title"></f:errors></span></td>
											...
											<tr>
												...
												<td>Auteur :*</td>
												<td><f:input path="author" />
												<span class="f_help"><f:errors path="author"></f:errors></span></td>
											</tr>
											<tr>

												<td>Catégorie :*</td>
												<td><f:input path="category" />
												<span class="f_help"><f:errors path="category"></f:errors></span></td>
											</tr>
											<tr>

												<td>Description :*</td>
												<td><f:input path="description" />
												<span class="f_help"><f:errors path="description"></f:errors></span></td>
											</tr>
											<tr>

												<td>Prix :*</td>
												<td><f:input path="price" />
												<span class="f_help"><f:errors path="price"></f:errors></span></td>
											</tr>
											<tr>

												<td>Numbre de copies :*</td>
												<td><f:input path="copy_number" />
												<span class="f_help"><f:errors path="copy_number"></f:errors></span></td>
											</tr>



										</table>
										<div style="color: red;">${isbn }</div>
							...
							<div id="footer">
								&copy; Copyright 2015 <span class="tip"><a href="#"
									title=">UPEM val-de-marne France">UPEM val-de-marne France</a> </span>
							</div>
						</div>
						<!--// End inner -->
